...
class PostParent
{
    ...
    /**
     * Deregisters the Yoast SEO metabox from the post type
     *
     * @return $this
     * @since 1.0
     * @chainable
     */
    public function removeYoastSeo()
    {
        remove_meta_box('wpseo_meta', $this->getPostTypeSlug(), 'normal');
        return $this;
    }
