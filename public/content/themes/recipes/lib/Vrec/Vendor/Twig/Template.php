...
class Template
{
     ...
     * Constructor
     *
     * @param \Vrec\Vendor\Twig\TwigInterface $controller
     * @since 1.0
     */
    public function __construct($controller)
    {
        ...
        try {
            if(!in_array('\Vrec\Vendor\Twig\TwigInterface', $interfaces) == false) {
                throw new \Exception('FATAL ERROR: Controller ' . get_class($controller) . ' must implement \Vrec\Vendor\Twig\TwigInterface');
            }
        } catch (\Exception $e) {
            die($e->getMessage());
        }
